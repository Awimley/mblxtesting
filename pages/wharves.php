...
<head>
    ...
    <title>MBLX &middot; Wharves</title>
...
<script type="text/javascript" src="/public/js/jquery.treegrid.bootstrap3.js"></script>
    ...
    <script src="/public/js/mblx.Wharves.DataAccess.js" type="text/javascript"></script>
        ...
        <script src="/pages/page_js/wharfPage.js" type="text/javascript"></script>
...
<?php include('../Includes/mblx_navbar.php'); ?>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <button id="addWharfButton" class="btn btn-block btn-primary">Add New Wharf</button>
            </div>
            <div class="col-xs-6">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-8">
                <table id="wharfTable" class="table tree table-striped">
     ...
     <?php include( '../Includes/modals/mblx_modal_wharves.php'); ?>
