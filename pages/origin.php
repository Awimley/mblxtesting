...
<head>
    ...
    <script src="/pages/page_js/originsPage.js" type="text/javascript"></script>
...
<?php include('../Includes/mblx_navbar.php'); ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <button id="addOriginButton" class="btn btn-block btn-primary">Add New Origin</button>
            </div>
            <div class="col-xs-6">
            </div>
        </div>
     ...
     <?php include( '../Includes/modals/mblx_modal_origins.php'); ?>
