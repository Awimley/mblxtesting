...
function onGetCustomersComplete(dataz) {
    ...
    jQuery.each(data, function (q, r) {
        ...
        listItemString += '<tr> \
                   ...
                   <td>' + r.postCode + '</td> \
                   <td>' + r.country + '</td> \
                    <td><a href="#" tabindex="0" class="btn btn-xs btn-default" role="button" data-toggle="popover" data-trigger="focus"  title="Contacts : ' + r.name + '" id="contactsShowButton_' + r.id + '" class="btn btn-block btn-primary">Show Contacts</a></td> \
                    <td>' + r.email + '</td> \
