...
try {
  //$query_insert_customer = ;
      $statement = $databaseConnection->prepare("UPDATE mblxdev.tblbargelines SET name = ?,contact = ?,address = ?, city = ?, state = ?,zip = ?, phone = ?, fax = ?, notes = ?, email = ?, active = ? WHERE bargeLineID = ? ");
